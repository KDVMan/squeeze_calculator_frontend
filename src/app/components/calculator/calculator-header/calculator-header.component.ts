...
@Component({
	...
	standalone: true,
	imports: [ReactiveFormsModule, CalculatorHeaderDateComponent, CalculatorHeaderCalculateComponent, CalculatorHeaderStartComponent, CalculatorHeaderUpdateComponent]
})
