...
@Component({
    selector: 'app-chart-settings-mouse',
    templateUrl: './chart-settings-mouse.component.html',
    standalone: true,
    imports: [ReactiveFormsModule, FormInputNumberComponent]
})
export class ChartSettingsMouseComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit(): void {
        this.formGroup = HelperService.createFormGroupFromModel(this.formBuilder, this.chartSettingsService.model.mouse);
        ...
        this.subscriptionFormGroup = this.formGroup.valueChanges.pipe(
            ...
            this.chartSettingsService.updateModel({
                mouse: HelperService.createModelFromFormGroup(this.formGroup)
            });
        });
    }
