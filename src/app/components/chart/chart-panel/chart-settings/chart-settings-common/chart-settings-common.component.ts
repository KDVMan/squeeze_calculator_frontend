...
@Component({
    selector: 'app-chart-settings-common',
    templateUrl: './chart-settings-common.component.html',
    standalone: true,
    imports: [ReactiveFormsModule, FormInputNumberComponent, FormInputColorComponent]
})
export class ChartSettingsCommonComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit(): void {
        this.formGroup = this.formBuilder.group({
            fontSize: this.chartSettingsService.model.fontSize,
            backgroundColor: this.chartSettingsService.model.backgroundColor
        });
        ...
        this.subscriptionFormGroup = this.formGroup.valueChanges.pipe(
            ...
            this.chartSettingsService.updateModel({
                fontSize: Number(this.formGroup.get('fontSize').value),
                backgroundColor: this.formGroup.get('backgroundColor').value
            });
        });
    }
