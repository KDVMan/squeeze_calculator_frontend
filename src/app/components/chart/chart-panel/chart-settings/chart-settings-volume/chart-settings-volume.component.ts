...
@Component({
    selector: 'app-chart-settings-volume',
    templateUrl: './chart-settings-volume.component.html',
    standalone: true,
    imports: [ReactiveFormsModule, FormInputNumberComponent, FormInputColorComponent, NgForOf]
})
export class ChartSettingsVolumeComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit(): void {
        this.formGroup = HelperService.createFormGroupFromModel(this.formBuilder, this.chartSettingsService.model.volume);
        ...
        this.subscriptionFormGroup = this.formGroup.valueChanges.pipe(
            ...
            this.chartSettingsService.updateModel({
                volume: HelperService.createModelFromFormGroup(this.formGroup)
            });
        });
    }
